...
namespace Astar.Vanguard.Server.Services
{
    ...
    {
        private readonly string _traderFolderDir = System.IO.Path.Join(configService.GetModPath(), "Assets", "database", "traders", VanguardTraderId);
        ...
        {
            var iconPath = System.IO.Path.Join(_traderFolderDir, $"{VanguardTraderId}.jpg");
            ...
            if (!ragfairConfig.Traders.ContainsKey(VanguardTraderId))
            {
                ragfairConfig.Traders[VanguardTraderId] = true;
            }
        }
        ...
        public void Compensation(CompensationRequestData info)
        {
            ...
            mailSendService.SendLocalisedNpcMessageToPlayer(
                ...
                Locales.VANGUARDTRADERCOMPENSATION,
        ...
        public bool CheckProfileTraderInfo(MongoId mcsLeadPlayerId)
        {
            ...
            return targetPmcData.TradersInfo.ContainsKey(VanguardTraderId);
        }

        public bool CheckServerTraderTable()
        {
            return databaseService.GetTables().Traders.ContainsKey(VanguardTraderId);
        }
    }
}