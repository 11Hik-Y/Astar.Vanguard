...
namespace Astar.Vanguard.Server.Generators.OrderQuestGeneration
{
    [Injectable]
    ...
    )
    {
        ...
        )
        {
            ...
            traderInfos.TryGetValue(Services.TraderService.VanguardTraderId, out var vanguardTraderInfo);
            var loyaltyLevel = vanguardTraderInfo is null ? 1 : vanguardTraderInfo.LoyaltyLevel;
            ...
            var order = Generate(players, carryServiceLevel, duration, discount, Services.TraderService.VanguardTraderId, questTemplate, punishmentMulti);
            return order;
        }
