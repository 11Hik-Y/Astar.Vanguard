...
namespace Astar.Vanguard.Server.ChatBot.Commands
{
    [Injectable]
    ...
    ) : IMcsCommand
    {
        ...
        public string[] CommandHelps
        {
            get
            {
                ...
                return [
                    string.Format(
                        serverLocalisationService.GetText(Locales.VANGUARDTRADERORDERCOMMANDHELP1),
                        Command,
                        Command,
                        Command
                        ),
                    string.Format(
                        serverLocalisationService.GetText(Locales.VANGUARDTRADERORDERCOMMANDHELP2),
                    ...
                    serverLocalisationService.GetText(Locales.VANGUARDTRADERORDERCOMMANDHELP3) + sb.ToString(),
                    ];
            }
        }
        ...
        public ValueTask<string> PerformAction(UserDialogInfo commandHandler, MongoId sessionId, SendMessageRequest request)
        {
            ...
            if (match.Success)
            {
                ...
                mailSendService.SendLocalisedNpcMessageToPlayer(
                    ...
                    Locales.VANGUARDTRADERORDERNEWQUEST,
                    null
                );
            ...
            else
            {
                mailSendService.SendLocalisedNpcMessageToPlayer(
                    ...
                    TraderService.VanguardTraderId,
                    MessageType.NpcTraderMessage,
                    Locales.VANGUARDTRADERCOMMANDERROR,
                    null
                );
            }
            return new(dialogId);
