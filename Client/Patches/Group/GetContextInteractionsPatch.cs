...
namespace Astar.Vanguard.Client.Patches.Group
{
    ...
    public sealed class GetContextInteractionsPatch : ModulePatch
    {
        ...
        public static async Task OnExitMcsBotPlayerInventoryMode(string aid)
        {
            ...
            EventMgr.Notify(new UpdateVanguardTraderAssortmentEvent());
        ...
        private static void OnRenewMcsOrder(string aid)
        {
            ...
            NotificationManagerClass.DisplayMessageNotification(Locales.VANGUARDTRADERORDERNEWQUEST.McsLocalized());
