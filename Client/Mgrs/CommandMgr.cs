...
namespace Astar.Vanguard.Client.Mgrs
{
    public class CommandMgr : BaseMgr
    {
        ...
        void Update()
        {
            ...
            if (KeyInput.BetterIsDown(AstarVanguardPlugin.CommandHotKey.Value))
            {
        ...
        public virtual void BuildMemberMenu(McsCommandMenu menu, Player[] mcsBotPlayers)
        {
            ...
            menu.RegisterCommand(Locales.OPENINVENTORYCOMMAND_NAME, Locales.OPENINVENTORYCOMMAND_TARGETNAME, ECommandType.OpenInventory.ToString(), mcsBotPlayers, isLocal: true, disabled: () => AstarVanguardPlugin.McsPluginClientConfig.BalanceRestriction);
