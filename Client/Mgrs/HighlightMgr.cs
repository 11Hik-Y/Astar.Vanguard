...
namespace Astar.Vanguard.Client.Mgrs
{
    public class HighlightMgr : BaseMgr
    {
        ...
        public override void Start()
        {
            ...
            AstarVanguardPlugin.TeammateHighlight.SettingChanged += (object sender, EventArgs e) =>
            {
                ...
                if (AstarVanguardPlugin.TeammateHighlight.Value)
                {
                    SwitchShaders();
                }
                else
        ...
        void Update()
        {
            if (KeyInput.KeyDown(AstarVanguardPlugin.TeammateHighlightHotKey.Value, AstarVanguardPlugin.TeammateHighlight))
            {
                if (!AstarVanguardPlugin.TeammateHighlight.Value)
                {
                    _commandBuffer.Clear();
        ...
        void SwitchShaders()
        {
            ...
            foreach (var playerData in Gameloop.GetDatas<PlayerData, PlayerDataMgr>())
            {
                ...
                BatchRenderers(playerData.Player, Gameloop.HighlightShader, AstarVanguardPlugin.TeammateHighlightColor.Value.linear);
            }
