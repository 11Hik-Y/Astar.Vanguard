...
using Astar.Vanguard.Client.Patches.RefreshQuests;
using Astar.Vanguard.Client.Patches.Raid;
using Astar.Vanguard.Client.Patches.Bots;
using Astar.Vanguard.Client.Patches.Group;
using Astar.Vanguard.Client.Patches.BepInEx;
using Astar.Vanguard.Client.Patches.Events;
using System.Text.RegularExpressions;
using Astar.Vanguard.Client.Patches.BigSurvey;
...
using Astar.Vanguard.Client.Patches.Inventory;
using Astar.Vanguard.Client.Patches.SAIN;
using System.Reflection;
using SPT.Reflection.Patching;
using Astar.Vanguard.Client.Patches.Interactive;
...
namespace Astar.Vanguard.Client
{
    ...
    public sealed class AstarVanguardPlugin : BaseUnityPlugin
    {
        ...
        public const string McsGUID = "com.astar.vanguard";
        public const string FikaGUID = "com.fika.core";
        public const string BigBrainGUID = "xyz.drakia.bigbrain";
#if DEBUG
        public const string McsPluginName = "Astar Vanguard Debug";
#else
        public const string McsPluginName = "Astar Vanguard";
#endif
        public const string VanguardTraderId = "6952ced4bcc1dd1e3c80dfcb";
        public static AstarVanguardPlugin Instance;
        ...
        public static new readonly ManualLogSource Logger = BepInEx.Logging.Logger.CreateLogSource("Astar Vanguard");
        ...
        private void EnableAllPatches()
        {
            ...
            _patches.Add(new VanguardTraderSelectionPatch());
