...
namespace Astar.Vanguard.Client.Bots.Brain.Logics
{
    public abstract class McsBotBaseLogic(BotOwner botOwner) : CustomLogic(botOwner)
    {
        ...
        protected async Task<bool> HandleLootAction(McsBotPlayerData mcsBotPlayerData, LootData targetLootData)
        {
            ...
            {
#if DEBUG
                // AstarVanguardPlugin.Logger.LogWarning("触发拿取战利品1");
#endif
            ...
            else
            {
                ...
                {
#if DEBUG
                    // AstarVanguardPlugin.Logger.LogWarning("触发装备战利品");
#endif
                ...
                {
#if DEBUG
                    // AstarVanguardPlugin.Logger.LogWarning("触发嵌套战利品");
#endif
                ...
                {
#if DEBUG
                    // AstarVanguardPlugin.Logger.LogWarning("触发交换战利品");
#endif
                ...
                {
#if DEBUG
                    // AstarVanguardPlugin.Logger.LogWarning("触发拿取战利品2");
#endif
                    await InteractionDelay(targetLootData);
                    return await Take(mcsBotPlayerData, targetLootData);
                }
